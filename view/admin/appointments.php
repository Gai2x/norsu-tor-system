...
<div class="p-4 sm:p-6 lg:p-10 space-y-8">
    ...
    <div class="bg-white rounded-3xl shadow overflow-hidden">
        <div class="px-4 sm:px-6 lg:px-8 py-5 sm:py-6 border-b flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
            ...
            <input type="text" placeholder="Search..." class="border border-gray-300 rounded-2xl px-4 py-3 w-full lg:w-80 min-h-[44px] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
        </div>
                ...
                <?php foreach ($appointments as $app) : ?>
                    ...
                    <article class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-4">
                        <div class="flex items-start justify-between gap-3">
                            <div>
                                <p class="text-xs font-semibold tracking-wide text-gray-400 uppercase">#APT-<?php echo $app['id']; ?></p>
            ...
            <table class="w-full min-w-[920px] text-left">
                ...
                <?php if (!empty($appointments)) : ?>
                    ...
                    <tr class="border-t hover:bg-gray-50">
                        <td class="px-6 lg:px-8 py-5 font-semibold sticky left-0 bg-white"><?php echo '#APT-' . $app['id']; ?></td>
